...
- **構築入力** — 自分・相手の6体（ポケモン名・持ち物・特性・性格・テラスタイプ・技・実数値/努力値・各種メモ・メガ候補フラグ・メガ運用分類）
- **構築テキストインポート** — ポケソル形式の構築テキストを貼り付けて6体を一括取り込み（種族/性別/フォーム/持ち物/特性/性格/テラス/実数値・努力値/技を解析、メガストーン所持は自動でメガ候補化）
